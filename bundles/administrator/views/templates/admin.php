<div class="table_container">
	<div class="results_header">
		<h2>${modelTitle}</h2>
		<div class="paginator">
			<input type="button" class="btn" value="prev" data-bind="attr: {disabled: pagination.isFirst() || !pagination.last() }, click: function() {page('prev')}" />
			<input type="button" class="btn" value="next" data-bind="attr: {disabled: pagination.isLast() || !pagination.last() }, click: function() {page('next')}" />
