...
<form class="edit_form" data-bind="visible: !loadingItem(), submit: saveItem">
	...
	<div class="control_buttons">
		{{if $root[$root.primaryKey]()}}
			<input type="button" class="btn" value="Close" data-bind="click: closeItem, attr: {disabled: freezeForm() || freezeActions()}" />
			<input type="button" class="btn btn-danger" value="Delete" data-bind="click: deleteItem, attr: {disabled: freezeForm() || freezeActions()}" />
			<input type="submit" class="btn btn-primary" value="Save" data-bind="attr: {disabled: freezeForm() || freezeActions()}" />
		{{else}}
			<input type="button" class="btn" value="Cancel" data-bind="click: closeItem, attr: {disabled: freezeForm() || freezeActions()}" />
			<input type="submit" class="btn btn-primary" value="Create" data-bind="attr: {disabled: freezeForm() || freezeActions()}" />
		{{/if}}
